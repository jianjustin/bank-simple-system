...
public class Contants {
    ...
    public static final String dbType = Contants.mysqlType;
    ...
    /*mysql数据库连接*/
    public static final String mysqlUrl = "jdbc:mysql://127.0.0.1:3306/bankSystemDb?characterEncoding=utf8&useSSL=true";
    public static final String mysqlUsername = "root";
    public static final String mysqlPassword = "jian031018";
    public static final String mySqlSchema = "bankSystemDb";
